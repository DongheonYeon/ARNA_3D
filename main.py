...
if __name__ == "__main__":
    ...
    # result = main(r".\data\case_S004\mask\segment_A.nii.gz")
    # result = main(r".\data\case_S016\mask\segment_A.nii.gz")
    # result = main(r".\data\test_001\mask\segment_A.nii.gz")
    result = main(r".\data\test_006\mask\segment_A.nii.gz")